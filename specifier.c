 ...
 *
 * Return: If flag characters are matched - a corresponding value. Otherwise - 0.
 */
unsigned char handle_flags(const char *flag, char *index)
{
int i, j;
 ...
 * @index: An index counter for the original format string.
 *
 * Return: If a lenth modifier is matched - its corresponding value. Otherwise - 0.
 */
unsigned char handle_length(const char *modifier, char *index)
{
if (*modifier == 'h')
 ...
 * @index: An index counter for the original format string.
 *
 * Return: If a precision modifier is matched - its value. If the precision modifier is empty, zero, or negative - 0. Otherwise - -1.
 */
int handle_precision(va_list args, const char *modifier, char *index)
{
int value = 0;
 ...
 *
 * Return: If a conversion function is matched - a pointer to the function. Otherwise - NULL.
 */
unsigned int (*handle_specifiers(const char *specifier))(va_list, buffer_t *, unsigned char, int, int, unsigned char)
{
int i;
